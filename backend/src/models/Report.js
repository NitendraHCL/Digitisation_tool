...
const reportSchema = new mongoose.Schema({
  ...
  // Observation data fetched from Observation collection when OrderID is validated
  observationData: {
    account_time_zone: { type: String, default: '' },
    uhId: { type: String, default: '' },
    patientId: { type: String, default: '' },
    facility_id: { type: String, default: '' },
    account_id: { type: String, default: '' },
    serviceType_code: { type: String, default: '' },
    orderId: { type: String, default: '' },
    accessionIdentifier: { type: String, default: '' },
    ...
    payer_type: { type: String, default: '' },
    orderDateTime: { type: Number, default: null },
    telecom: { type: String, default: '' },
    center_type_name: { type: String, default: '' },
    package_id: { type: String, default: '' },
    part_of_package: { type: Boolean, default: false },
    package_name: { type: String, default: '' },
    email: { type: String, default: '' },
    center_name: { type: String, default: '' },
    orderBy: { type: String, default: '' },
    care_type: { type: String, default: '' },
    care_type_name: { type: String, default: '' },
    status: { type: String, default: '' },
    acknowledgedDateTime: { type: String, default: '' },
    outSourceCentre: { type: String, default: '' },
    orderReferenceId: { type: String, default: '' },
    reportStatus: { type: String, default: '' },
    uploadedDocumentId: { type: String, default: '' },
    verificationDateTime: { type: Number, default: null },
    outSourceCentre_id: { type: String, default: '' },
    admittingDoctor: { type: String, default: '' },
    cug_code: { type: String, default: '' },
    package_service_code: { type: String, default: '' },
