  ...
  app.use((req, res, next) => {
    ...
    res.setHeader(
      ...
      [
        ...
        "font-src 'self' data:",
        "connect-src 'self' http://localhost:5010 ws://localhost:3003", // WebSocket for hot reload
        "frame-src 'self' http://localhost:5010", // Allow iframes to load PDFs from backend
